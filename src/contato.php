		...
		<div class="row contato-fundo-contato">
			<div class="col-sm-6">
				<form action="acts/acts.contato.php" method="post" enctype="multipart/form-data">
				  ...
				  <div class="row cont-index-contato">  
				    <div class="col-8">
				      <input type="email" name="email" id="email" class="form-control form-cont-index-contato" placeholder="E-mail">
				    </div>
				    <div class="col-4">
				  ...
				  <div class="row cont-index-contato">
				    <div class="col">
				      <input type="text" name="assunto" id="assunto" class="form-control form-cont-index-contato" placeholder="Assunto">
				    </div>
				  </div>
