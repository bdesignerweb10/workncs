				...
				try {
					...
					if(isset($_POST) && !empty($_POST) && $_POST["nome"]) {
						...
						if(!$isValid) {
							...
							$qry_cursos = "INSERT INTO cursos (nome, descricao, data_inicio, inscricao_aberta ,destaque, ativo) VALUES ('" . $nome . "','" . $descricao . "', '". $data_inicio ."' ,'" . $inscricao_aberta . "','" . $destaque . "','" . $ativo . "')";
